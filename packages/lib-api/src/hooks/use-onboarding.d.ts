...
export declare function useOnboardingProgress(options?: {
  ...
  import('@giulio-leone/constants').OnboardingProgress,
  Error
>;
/**
 * Hook to complete a step
 */
export declare function useCompleteStep(): import('@tanstack/react-query').UseMutationResult<
  import('@giulio-leone/constants').OnboardingProgress,
  Error,
  CompleteStepPayload,
  void
 ...
 */
export declare function useGoToStep(): import('@tanstack/react-query').UseMutationResult<
  import('@giulio-leone/constants').OnboardingProgress,
  Error,
  GoToStepPayload,
  void
 ...
 */
export declare function useResetOnboarding(): import('@tanstack/react-query').UseMutationResult<
  import('@giulio-leone/constants').OnboardingProgress,
  Error,
  void,
  void
 ...
 */
export declare function useCompleteAllSteps(): import('@tanstack/react-query').UseMutationResult<
  import('@giulio-leone/constants').OnboardingProgress,
  Error,
  void,
  void
